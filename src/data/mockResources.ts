...
export function getResourcesForZip(zip: string): Resource[] {
  ...
  const { lat, lng } = data;
  return [
    { id: "1", name: `${data.city} Public Library`, description: "Free computer access, printing, and digital literacy classes. Open 6 days a week.", category: "Technology", lat: lat + 0.008, lng: lng - 0.005, address: `123 Main St, ${data.city}`, distance: "0.3 mi" },
    { id: "2", name: "Community Learning Center", description: "After-school tutoring, homework help, and mentoring for K-12 students.", category: "Education", lat: lat - 0.005, lng: lng + 0.008, address: `456 Oak Ave, ${data.city}`, distance: "0.5 mi" },
    { id: "3", name: "Free Wi-Fi Hub @ Community Park", description: "Open-access Wi-Fi hotspot with outdoor seating. Available 6am–10pm.", category: "Technology", lat: lat + 0.012, lng: lng + 0.003, address: `789 Park Blvd, ${data.city}`, distance: "0.8 mi" },
    { id: "4", name: "Language & Immigration Center", description: "Free ESL classes, citizenship prep, and translation services in Spanish, Vietnamese, and Mandarin.", category: "Community Support", lat: lat - 0.009, lng: lng - 0.007, address: `321 Elm St, ${data.city}`, distance: "1.0 mi" },
    { id: "5", name: "UC Links Youth Program", description: "University-community partnership providing digital literacy, college prep, and STEM activities for underserved youth.", category: "Education", lat: lat + 0.003, lng: lng - 0.012, address: `555 University Way, ${data.city}`, distance: "1.2 mi", isUCLinks: true },
    { id: "6", name: "Neighborhood Tech Lab", description: "Refurbished laptops available for checkout, coding workshops every Saturday.", category: "Technology", lat: lat - 0.013, lng: lng + 0.005, address: `678 Tech Dr, ${data.city}`, distance: "1.5 mi" },
    { id: "7", name: "Family Resource Center", description: "Parenting classes, food assistance referrals, and youth development programs.", category: "Community Support", lat: lat + 0.006, lng: lng + 0.014, address: `890 Family Ln, ${data.city}`, distance: "1.8 mi" },
    { id: "8", name: "UC Links Digital Storytelling Lab", description: "UC-partnered program teaching digital media creation and storytelling to teens.", category: "Education", lat: lat - 0.002, lng: lng - 0.016, address: `111 Campus Rd, ${data.city}`, distance: "2.0 mi", isUCLinks: true },
  ];
}
