...
import { ArrowLeft, ChevronDown, ChevronUp, HelpCircle, MapPin, ShieldCheck, AlertTriangle, RefreshCw, Layers, Users, Lightbulb, Lock, Globe } from "lucide-react";
      ...
      <div className="section-container py-10 max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Everything you need to know about how we map environmental burden, surface community resources, and empower neighborhoods across California.
          </p>
        </div>
        ...
        <div className="space-y-3">
          {FAQ_ITEMS.map((item, i) => (
            ...
            >
              ...
              >
                <div className={`p-2 rounded-lg shrink-0 transition-colors ${openIndex === i ? "bg-primary/15 text-primary" : "bg-muted text-muted-foreground"}`}>
                  {item.icon}
                </div>
